 ...
 * Emits "click" (via my_widget_on) when released inside after a pointer or
 * keyboard activation.
...
typedef struct my_button_t {
  ...
  bool pointer_pressed;       /**< pointer activation is armed */
  bool keyboard_pressed;      /**< keyboard activation is armed */
  uint32_t keyboard_key;      /**< key that armed keyboard activation */
  ...
  bool cooldown_deadline_saturated;
  bool cooldown_reduced_motion;
