...
layout(push_constant) uniform PushConstants {
    ...
    mat4 u_proj;         /*  64 */
    mat4 u_light_vp;     /* 128 */
    vec4 u_camera_time;  /* 192 */
    vec4 u_color_bias;   /* 208 */
    vec4 u_watery;       /* 224 */
} pc;

#define u_camera_pos  (pc.u_camera_time.xyz)
#define u_time        (pc.u_camera_time.w)
#define u_water_color (pc.u_color_bias.xyz)
#define u_shadow_bias (pc.u_color_bias.w)
#define u_water_y     (pc.u_watery.x)
