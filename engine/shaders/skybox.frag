...
void main() {
    ...
    vec3 sky = u_sun_color * scattering * extinction;
    ...
    sky += u_sun_color * 0.1 * horizon_fog * extinction;
    ...
    if (ray.y > 0.01) {
        ...
        for (int i = 0; i < CLOUD_STEPS; i++) {
            ...
            if (cloud_d > 0.01) {
                ...
                vec3 light = u_sun_color * phase * (1.0 + cos_light * 0.5);
                vec3 ambient = u_sun_color * 0.15 * cloud_d;
