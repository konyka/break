...
layout(push_constant) uniform GRParams {
    layout(offset = 0)  float u_gr_sun_x;
    layout(offset = 4)  float u_gr_sun_y;
    layout(offset = 8)  float u_gr_intensity;
    layout(offset = 12) float u_gr_decay;
    layout(offset = 16) float u_gr_sw;
    layout(offset = 20) float u_gr_sh;
};
