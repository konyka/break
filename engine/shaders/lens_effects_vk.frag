...
layout(push_constant) uniform LensParams {
    layout(offset = 0)  float u_ca_strength;
    layout(offset = 4)  float u_vignette_strength;
    layout(offset = 8)  float u_vignette_softness;
    layout(offset = 12) float u_grain_strength;
};
