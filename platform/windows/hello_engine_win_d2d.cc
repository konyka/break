...
int WINAPI WinMain(HINSTANCE hInstance,
  ...
  // 告诉COM以一种所谓STA的方式运行。很粗略的来说可以认为COM组件是以一种与我们程序同步的方式运行。
  // COINIT_DISABLE_OLE1DDE
  // 关闭一些已经过时的COM功能，减少不必要的开销
